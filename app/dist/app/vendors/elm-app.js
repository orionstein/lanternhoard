...
var _rluiten$elm_date_extra$Date_Extra_Format$formatRegex = _elm_lang$core$Regex$regex('%(Y|m|_m|-m|B|^B|b|^b|d|-d|-@d|e|@e|A|^A|a|^a|H|-H|k|I|-I|l|p|P|M|S|%|L|z|:z)');
...
var _user$project$JsonHelper$apply = _elm_lang$core$Json_Decode$object2(
	F2(
		function (x, y) {
			return x(y);
		}));
var _user$project$JsonHelper$constructing = _elm_lang$core$Json_Decode$succeed;

var _user$project$StoreItem$storeItemView = F2(
	function (act, item) {
		return A2(
			_elm_lang$html$Html$tr,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('storeItem')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					function () {
					...
					if (_p0.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('itemName')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											A2(_elm_lang$core$Basics_ops['++'], 'https://shop.kingdomdeath.com', _p0._0)),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('itemPrice')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(item.price)
						]))
				]));
	});
var _user$project$StoreItem$StoreItem = F3(
	function (a, b, c) {
		return {title: a, price: b, link: c};
	});
var _user$project$StoreItem$decodeStoreItem = A2(
	_user$project$JsonHelper$apply,
	A2(
		_user$project$JsonHelper$apply,
		A2(
			_user$project$JsonHelper$apply,
			_user$project$JsonHelper$constructing(_user$project$StoreItem$StoreItem),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'price', _elm_lang$core$Json_Decode$string)),
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_elm_lang$core$Basics_ops['++'], 'storeItem ', item.status))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					function () {
					...
					switch (_p0) {
						case 'Lost':
							return A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('itemStatus')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('zmdi zmdi-minus')
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									]));
							...
							return A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('zmdi zmdi-plus')
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									]));
					...
					_elm_lang$core$Native_Utils.eq(item.status, 'Price') ? A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('itemPriceDelta')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('tooltip maintenanceTooltip'),
									(_elm_lang$core$Native_Utils.cmp(item.priceChange, 0) < 0) ? A2(
									_elm_lang$html$Html_Attributes$attribute,
									'data-text',
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Price Decreased by $',
										_elm_lang$core$Basics$toString(
											_elm_lang$core$Basics$abs(item.priceChange)))) : A2(
									_elm_lang$html$Html_Attributes$attribute,
									'data-text',
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Price Increased by $',
										_elm_lang$core$Basics$toString(
											_elm_lang$core$Basics$abs(item.priceChange))))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
										...
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													ctor: '_Tuple2',
													_0: 'color--alizarin',
													_1: _elm_lang$core$Native_Utils.cmp(item.priceChange, 0) > 0
												},
													{
													ctor: '_Tuple2',
													_0: 'color--nephritis',
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													(_elm_lang$core$Native_Utils.cmp(item.priceChange, 0) < 0) ? _elm_lang$html$Html_Attributes$class('zmdi zmdi-triangle-down') : _elm_lang$html$Html_Attributes$class('zmdi zmdi-triangle-up')
												]),
											_elm_lang$core$Native_List.fromArray(
												[])),
											A2(
...
var _user$project$StoreItemDiff$StoreItemDiff = F5(
	function (a, b, c, d, e) {
...
var _user$project$StoreEntryDiff$storeEntryView = F2(
	function (act, entry) {
		var date = _elm_lang$core$Date$fromTime(entry.date);
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('entryDate m-b--20')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text(
									A3(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, '%B %-@d, %Y - %l:%M%p', date))
								]))
						])),
					(_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$List$length(entry.diff),
					0) > 0) ? A2(
					_elm_lang$html$Html$table,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('storeItemDiffs')
						]),
					A2(
						_elm_lang$core$List$map,
						_user$project$StoreItemDiff$storeItemDiffView(act),
						entry.diff)) : A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[]),
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('m-t--20')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('d--inline m-r--10')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('No change since last entry ')
										])),
									A2(
									_elm_lang$html$Html$span,
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('tooltip maintenanceTooltip d--inline'),
											A2(_elm_lang$html$Html_Attributes$attribute, 'data-text', 'Usually this is because of a change in the code. Last known, adding links crawled from the store.')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											A2(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('zmdi zmdi-info')
												]),
											_elm_lang$core$Native_List.fromArray(
												[]))
										]))
					...
					(_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$List$length(entry.items),
					0) > 0) ? A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('collapsible-wrap')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Full List')
								])),
							A2(
							_elm_lang$html$Html$div,
							_elm_lang$core$Native_List.fromArray(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('storeItems')
										]),
									A2(
										_elm_lang$core$List$map,
										_user$project$StoreItem$storeItemView(act),
										entry.items))
								]))
						])) : A2(
					_elm_lang$html$Html$div,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('All items removed - store empty. This is usually due to Kingdom Death Store Maintenance. '),
									A2(
									_elm_lang$html$Html$span,
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('tooltip maintenanceTooltip'),
											A2(_elm_lang$html$Html_Attributes$attribute, 'data-text', 'This is stored for historical reasons. I might remove these in the future.')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											A2(
...
var _user$project$StoreEntryDiff$getEntryDiff = F2(
	function (a, b) {
		var convertDollars = function (price) {
			return A2(
				_elm_lang$core$Result$withDefault,
				0.0,
				_elm_lang$core$String$toFloat(
					A2(_elm_lang$core$String$dropLeft, 1, price)));
		};
		var buildNewDiffItem = function (item) {
			var origItem = A2(
				_elm_lang$core$Maybe$withDefault,
				A3(_user$project$StoreItem$StoreItem, '', '', _elm_lang$core$Maybe$Nothing),
				_elm_lang$core$List$head(
					A2(
						...
						function (or) {
							return _elm_lang$core$Native_Utils.eq(
								or.title,
								_elm_lang$core$Basics$fst(item));
						},
						a.items)));
			var _p0 = A2(
				_elm_lang$core$List$filter,
			...
			if (_p0.ctor === '::') {
				if (_p0._1.ctor === '[]') {
					var _p1 = _p0._0;
					return A5(
						_user$project$StoreItemDiff$StoreItemDiff,
						_p1.title,
						_elm_lang$core$Basics$snd(item),
						origItem.link,
						'Price',
						_elm_lang$core$Basics$snd(item) - convertDollars(_p1.price));
				} else {
					return A5(
						_user$project$StoreItemDiff$StoreItemDiff,
						_elm_lang$core$Basics$fst(item),
		...
		var setNameA = _elm_lang$core$Set$fromList(
			A2(
				_elm_lang$core$List$map,
				function (t) {
					return {
						ctor: '_Tuple2',
						_0: t.title,
						_1: convertDollars(t.price)
					};
				},
				a.items));
		var setNameB = _elm_lang$core$Set$fromList(
			A2(
				_elm_lang$core$List$map,
				function (t) {
					return {
				...
				b.items));
		var diffNew = _elm_lang$core$Set$toList(
			A2(_elm_lang$core$Set$diff, setNameA, setNameB));
		var itemDiffNew = A2(_elm_lang$core$List$map, buildNewDiffItem, diffNew);
		var diffLost = _elm_lang$core$Set$toList(
			A2(
					...
					return _elm_lang$core$Basics$not(
						A2(
							...
							function (lItem) {
								return _elm_lang$core$Native_Utils.eq(
									lItem.title,
									_elm_lang$core$Basics$fst(test));
							},
							a.items));
				},
				A2(_elm_lang$core$Set$diff, setNameB, setNameA)));
		var itemDiffLost = A2(
			_elm_lang$core$List$map,
			function (t) {
				return A5(
		...
		F2(
			function (a, b) {
				return A2(
					_elm_lang$core$List_ops['::'],
					A2(
						_user$project$StoreEntryDiff$getEntryDiff,
						a,
						A2(
							_elm_lang$core$Maybe$withDefault,
							A3(
...
var _user$project$StoreWatchElm$decodeEntries = _elm_lang$core$Json_Decode$list(_user$project$StoreEntry$decodeStoreEntry);
var _user$project$StoreWatchElm$action = _elm_lang$core$Native_Platform.outgoingPort(
	'action',
	function (v) {
		return v;
	});
var _user$project$StoreWatchElm$entries = _elm_lang$core$Native_Platform.incomingPort('entries', _elm_lang$core$Json_Decode$value);
var _user$project$StoreWatchElm$Model = F2(
	function (a, b) {
		return {formNumber: a, entries: b};
	});
var _user$project$StoreWatchElm$init = {
	ctor: '_Tuple2',
	_0: A2(
		_user$project$StoreWatchElm$Model,
		'',
		_elm_lang$core$Native_List.fromArray(
			[])),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$StoreWatchElm$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Update':
				return {
					...
					_0: A2(
						_user$project$StoreWatchElm$Model,
						'',
						_user$project$StoreEntryDiff$diffAllEntries(
							A2(
								_elm_lang$core$Result$withDefault,
								_elm_lang$core$Native_List.fromArray(
									[]),
								A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$StoreWatchElm$decodeEntries, _p0._0)))),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Action':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$StoreWatchElm$action(
...
var _user$project$StoreWatchElm$UpdateNumber = function (a) {
	return {ctor: 'UpdateNumber', _0: a};
};
var _user$project$StoreWatchElm$Action = function (a) {
	return {ctor: 'Action', _0: a};
};
var _user$project$StoreWatchElm$view = function (model) {
	var submitMsg = function (val) {
		return _elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string('SubmitMobile')
				},
					{
					ctor: '_Tuple2',
					_0: 'number',
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('kingdomDeathStore')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('header text-left p-l-10 clearfix')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('c-black left g--6 g-s--6 g-t--12 no-margin')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Kingdom Death Store Tracker')
							])),
						A2(
						_elm_lang$html$Html$form,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('left g--4 g-s--6 g-t--12 no-margin'),
								_elm_lang$html$Html_Events$onSubmit(
								_user$project$StoreWatchElm$Action(
									submitMsg(model.formNumber)))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$for('kdmMobileNotification'),
										_elm_lang$html$Html_Attributes$class('d--block')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Enter your phone number to be notified by text when the Kingdom Death Store updates.')
									])),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Attributes$class('d--inline m-r--20'),
												_elm_lang$html$Html_Attributes$id('kdmMobileNotification'),
												_elm_lang$html$Html_Attributes$value(model.formNumber),
												_elm_lang$html$Html_Events$onInput(_user$project$StoreWatchElm$UpdateNumber)
											]),
										_elm_lang$core$Native_List.fromArray(
											[])),
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Attributes$class('mobileSubmitBtn btn-raised d--inline bg--teal color--white')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('description clearfix g--8 g-s--12')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('The Lantern Hoard Store Watch was created to record and compare the storefront at '),
								A2(
								_elm_lang$html$Html$a,
								_elm_lang$core$Native_List.fromArray(
									[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('shop.kingdomdeath.com')
									])),
								_elm_lang$html$Html$text('.')
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Entries are shown newest first, and display the changes to the store. The Full List will show a snapshot of all items at that time.')
							])),
						A2(
						_elm_lang$html$Html$p,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Items with a '),
								A2(
								_elm_lang$html$Html$i,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('zmdi zmdi-plus color--nephritis')
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
								_elm_lang$html$Html$text(' are new items, items with a '),
								A2(
								_elm_lang$html$Html$i,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('zmdi zmdi-minus color--alizarin')
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
								_elm_lang$html$Html$text(' are removed items, and items with a ~ are changed items - if the price changes, the difference will be displayed as well.')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$StoreEntryDiff$storeEntryView(_user$project$StoreWatchElm$Action),
					model.entries))
			]));
};
var _user$project$StoreWatchElm$Update = function (a) {
	return {ctor: 'Update', _0: a};
};
var _user$project$StoreWatchElm$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$StoreWatchElm$entries(_user$project$StoreWatchElm$Update)
			]));
};
var _user$project$StoreWatchElm$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$StoreWatchElm$init, view: _user$project$StoreWatchElm$view, update: _user$project$StoreWatchElm$update, subscriptions: _user$project$StoreWatchElm$subscriptions})
};

var Elm = {};
Elm['StoreWatchElm'] = Elm['StoreWatchElm'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['StoreWatchElm'], 'StoreWatchElm', typeof _user$project$StoreWatchElm$main === 'undefined' ? null : _user$project$StoreWatchElm$main);
